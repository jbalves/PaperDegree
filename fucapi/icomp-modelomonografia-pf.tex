...
\chapter{Introdução}
	...
	\section{Metodologia de Desenvolvimento}
		...
		Com base na metodologia utilizada no processo de Descoberta de Conhecimento em Base de Dados (Knowledge Dicovery in Databases) definida em \cite{fayyad:1996}, a realização desta pesquisa será composta das seguintes etapas:
...
Este Capitulo apresenta uma visão geral dos conceitos envolvidos nas várias técnicas de classificação utilizadas ao longo deste trabalho.
