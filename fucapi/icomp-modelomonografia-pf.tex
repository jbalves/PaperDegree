...
\\
	...
	\subsection{Árvore de Decisão IMPORTANTE}
		...
		Árvores de Decisão é, provavelmente, o algortimo de Aprendizagem de Máquina mais estudado em Mineração de dados WITTEN, FRANK, 2000.
...
\chapter{Resultados}
	...
	Portanto, a melhor abordagem para a Validação Crizada é a utilização do método de k-partições. Neste método, o conjunto de dados é dividio em k partições segundo Witten e frank 2000.
