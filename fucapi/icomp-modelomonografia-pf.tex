...
%		$\lambda$
	...
	\begin{itemize}
		...
		\item \textit{Precision}: Percentual de instâncias classificadas corretamente sobre todo o conjunto de dados.
		\item \textit{Recall}: Proporção de instâncias classificadas positivamente dentre todos os positivos.
